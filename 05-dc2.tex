...
\end{equation}
	...
	\item Plot \todo{Plot V vs. I to determine internal resistance of the battery. Extends the task of measurement of V and I for each resistor.}the measured voltage value vs. current for each resistor, including the \emph{emf} voltage when there is no current. The slope of the line gives a reasonable value for the internal resistance of the battery.
