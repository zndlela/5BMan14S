...
\begin{marginfigure}
	\centering
	\includegraphics[width=0.9\linewidth]{InternalResistance.pdf}
...
\begin{enumerate}
	...
	\item Measure the actual resistances of the three precision resistors with the ohmmter.
	 \item Set up the circuit shown in \fref{f:vimtr}.  Use a precision resistor for $R$, and estimate the current that will flow so that you can choose an appropriate scale for the ammeter.
...
\begin{enumerate}
	...
	\item What two conservation principles are used by Kirchhoff's rules?\sidenote{Textbook, Section 19.6}  
