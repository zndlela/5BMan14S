...
\section{Purpose}
This laboratory period will let you exercise your measuring and graphing skills by mapping the equipotential\sidenote{\textsc{Equipotential Lines} are the invisible lines that exist at constant voltage.  You will find them them in the experiment and then draw a representation of them on your graph paper.} lines that are formed between two parallel bars that are maintained at a voltage difference.  You should be able show a relationship between distance and voltage that will allow you to measure the electric field using Equation \ref{e:EandV}.
...
\end{enumerate}
	 \newthought{The dimples are not very visible under water} but once you have measured remove and dry the plastic sheet, the dimples will be easily seen.  
\begin{enumerate}[resume]
	...
	\item Measure the distance between two adjacent equipotential lines \textbf{along} the electric field line.
	\item Record your observations in your lab report.  Discuss with your lab partner and/or your instructor whether the equipotential and field lines have the shapes and behaviors you would expect for this geometry.
...
Repeat steps 1-5 for two small round electrodes that simulate point charges. Calculate the value of the electric filed between two (2) distinct locations.
