...
\todo{State explicitly the formula for percentage difference}
\end{enumerate}
...
\section{Questions}
\begin{enumerate}
	\item Estimate the experimental or instrumental uncertainties \marginnote{\[ \frac{\delta V}{V}, \frac{\delta I}{I}, \frac{\delta T}{T}, \frac{\delta m}{m}. \] The $\delta$'s are uncertainties not changes or differences. Very often, they are least counts in the instruments.}
